...
public interface IRelation {
   ...
   * @return true, if it was added, false if a tuple already exists in the relation with the same term values.
   */
  boolean add(ITuple tuple);

  /**
   * Add all tuples in relation 'relation' to this relation. The tuples in 'relation' MUST have the same arity as all
   * other tuples in this relation.
   * 
   * @param relation
